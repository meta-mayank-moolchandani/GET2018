...
public class ShoppingCart {
	...
	/**
	 * this function returns the reference of the product from product list
	 * which have the product named as thisProduct function for getting the
	 * reference of the Product by using it's name
	 * 
	 * @param thisProduct
	...
	/**
	 * this function returns the reference of the product from Shopping Cart
	 * list which have the product named as thisProduct function for getting the
	 * reference of the Product by using it's name
	 * 
	 * @param thisProduct
	 *            is the name of product
	 ...
	 * 
	 * @param product
	 *            is the name of the product, quantity is for storing the
	...
	public boolean addProductToCart(String product, int quantity) {
		if (isExistInProductList(product)) {
			if (isExistInCart(product)) {
				...
				Product existedItem = productReferenceOfShoppingCart(product);
				existedItem.productQuantity = existedItem.productQuantity
						+ quantity;
				...
				if (shoppingCart
						.contains(productReferenceOfProductList(product))) {
	...
	int checkout() {
		try {
			...
			while (iter.hasNext()) {
				...
				sum = sum + currentItem.productPrice
